/*
  # Human-AI Interface Optimization Schema

  1. New Tables
    - `optimization_results` - Stores content optimization recommendations
    - `ab_test_assignments` - Tracks A/B test variant assignments
    - `ab_test_results` - Stores results from A/B tests
    - `workflow_rules` - Defines content routing rules
    - `model_metrics` - Tracks ML model performance metrics
    - `model_alerts` - Logs alerts for model performance issues
