/*
  # Enterprise Infrastructure Schema

  1. New Tables
    - enterprise_clients: Manages enterprise client accounts
    - enterprise_users: Handles enterprise user management
    - content_requests: Tracks content creation requests
    - content_approvals: Manages content approval workflow
    - client_analytics: Stores client performance metrics
    - brand_voices: Manages client-specific voice models

  2. Security
    - RLS enabled on all tables
    - Policies for client data access
